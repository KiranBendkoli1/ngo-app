...
import 'package:ngo_app/models/user.dart' as model;
import 'package:ngo_app/providers/user_provider.dart';
import 'package:ngo_app/resources/firestore_methods.dart';
import 'package:ngo_app/screens/comments_screen.dart';
import 'package:ngo_app/utils/colors.dart';
import 'package:ngo_app/utils/utils.dart';
import 'package:ngo_app/widgets/like_animation.dart';
              ...
              IconButton(
                  ...
                  onPressed: () async {
                    ...
                    await Share.shareFiles([path],
                        text:
                            'Hey there, see I have contributed to an NGO by ${widget.snap['description']}');
                  }),
              Expanded(
                  child: Align(
